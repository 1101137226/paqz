...
public class boss80attack : MonoBehaviour {
	...
	void Update () {
		...
		case 2:
			...
			{GameObject.Find("dead").GetComponent<AudioSource>().Play();Instantiate(duoo);duflag=2;}
			else if(efftime>2 && duflag==2)
			{GameObject.Find("dead").GetComponent<AudioSource>().Play();Instantiate(duoo);duflag=3;}
			else if(efftime>3 && duflag==3)
			{GameObject.Find("dead").GetComponent<AudioSource>().Play();o=0;Instantiate(duoo);duflag=1;}
		...
		case 4:
			...
			if(efftime>=5.0f)
			{emenyhit.enemydamageup=1.0f;o=0;}
			break;
		case 5:
			if(inin)
			{inin=false;
		...
		case 7:
			...
			if(efftime>=2.0f)
			{Destroy(GameObject.Find("laser(Clone)").gameObject);charstuas.nowhp=charstuas.nowhp-2500;o=0;}
			break;
		case 8:
			if(inin){
		...
		case 11:
			...
			if(efftime>=5.0f)
			{Destroy(GameObject.Find("enfast").gameObject); newtempo.eaccel=1.0f;o=0;}
			break;
		case 12:
